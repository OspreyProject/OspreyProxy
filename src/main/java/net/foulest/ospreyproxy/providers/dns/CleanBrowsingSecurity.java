...
/**
 * Provider implementation for CleanBrowsing Security DNS.
 */
@Slf4j
@Component
public class CleanBrowsingSecurity extends AbstractDNSProvider {
     ...
     */
    public CleanBrowsingSecurity(MetricsService metricsService, CircuitBreakerService circuitBreakerService) {

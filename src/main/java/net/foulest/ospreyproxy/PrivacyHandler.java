...
/**
 * Controller for the <a href="https://api.osprey.ac/privacy">GET /privacy</a> endpoint.
 */
@Slf4j
@RestController
    ...
    private static @NonNull String computeOwnJarSha256() {
        try {
            ...
            if (uriString.startsWith("jar:")) {
                ...
                // Remove "jar:" prefix and everything after "!"
                if (separator > 0) {
                    uriString = uriString.substring(4, separator);
                }
